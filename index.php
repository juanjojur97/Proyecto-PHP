...
<body>
    <div class="container">
        <header class="my_header">
            <a href="index.html"><h1><img src="./assets/images/logo1.png" alt="Logo" class="logo"></h1></a>
            <nav class="navigationBar">
                <ul class="navigationBarList">
                    ...
                    <li>
                        <a href="./views/noticias.php" class="enlace">Noticias</a>
                    </li>
                    <li>
                        <a href="./views/registro.php" class="enlace">Registro</a>
                    </li>
                    <li>
                        <a href="./views/login.php" class="enlace">Login</a>
                    </li>
                </ul>
            </nav>
        </header>
